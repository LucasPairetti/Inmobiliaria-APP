...
Parent root = FXMLLoader.load((getClass().getResource("/interfaces/LoginPrincipal.fxml")));
	...
	public static void main(String[] args) {
		...
		*/
		...
		/*Date fecha = Date.valueOf("1999-06-15");
		VendedorDTO vendedor = new VendedorDTO("Juan", "Chort", TipoDNI.DNI.toString(), "41906985", "Necochea", 4101,
				"Santa Fe", "Santa Fe", 155282518, "julio@gmail.com", fecha, 300000.0,
				"1234");
